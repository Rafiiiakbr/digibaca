...
<div class="container py-4">
    ...
    <div class="alert alert-danger d-flex align-items-center gap-2 mb-4">
        ...
        <span>Anda memiliki <strong>{{ $stats['rejected'] }}</strong> buku yang ditolak admin. Periksa alasan penolakan di daftar buku.</span>
    </div>
    @endif
            ...
            <table class="table table-digibaca mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('author.books.edit', $book->id) }}" class="btn btn-sm btn-outline-digibaca" title="Edit Buku">
