...
<head>
    ...
    <title>@yield('title', 'Dashboard Penulis') — DigiBaca</title>
...
<body>
    <div class="sidebar-digibaca" id="sidebar">
        ...
        <nav class="py-2">
            ...
            <a href="{{ route('author.books.index') }}" class="nav-link {{ request()->routeIs('author.books.index') ? 'active' : '' }}">
    ...
    <div class="dashboard-content">
        <div class="dashboard-topbar">
            <div>
                ...
                <span class="fw-semibold">@yield('page-title', 'Dashboard Penulis')</span>
            </div>
