    ...
    <div class="row align-items-center py-5">
        <div class="col-lg-6 mb-4 mb-lg-0">
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-start">
                <a href="<?php echo e(route('register')); ?>" class="btn btn-primary btn-lg px-4 me-md-2 fw-semibold shadow-sm">Mulai Membaca</a>
                <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-secondary btn-lg px-4">Masuk</a>
            </div>
        </div>
