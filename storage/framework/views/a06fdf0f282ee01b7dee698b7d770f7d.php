...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Masuk'); ?> — DigiBaca</title>
    ...
    <div class="auth-wrapper">
        ...
        <div class="auth-form-side">
            <div class="auth-form-box">
                <a href="<?php echo e(route('home')); ?>" class="d-inline-flex align-items-center gap-2 mb-4 text-decoration-none d-lg-none">
...
</html><?php /**PATH C:\buku-digital\resources\views/layouts/auth.blade.php ENDPATH**/ ?>