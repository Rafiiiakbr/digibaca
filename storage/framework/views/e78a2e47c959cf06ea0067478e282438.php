...
<?php $__env->startSection('content'); ?>
    ...
    <form method="POST" action="<?php echo e(route('login')); ?>">
        ...
        <div class="mb-3">
            ...
            <input type="email" name="email" value="<?php echo e(old('email')); ?>" class="form-control form-control-digibaca" placeholder="nama@email.com" required autofocus>
        </div>
        ...
        <p class="text-center small text-muted">
            Belum punya akun? <a href="<?php echo e(route('register')); ?>" class="fw-semibold">Daftar sekarang</a>
        </p>
    </form>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\buku-digital\resources\views/auth/login.blade.php ENDPATH**/ ?>