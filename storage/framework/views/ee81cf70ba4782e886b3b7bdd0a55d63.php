...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard Admin'); ?> — DigiBaca</title>
...
<body>
    <div class="sidebar-digibaca" id="sidebar">
        ...
        <nav class="py-2">
            ...
            <a href="<?php echo e(route('admin.premium.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.premium.*') ? 'active' : ''); ?>">
    ...
    <div class="dashboard-content">
        <div class="dashboard-topbar">
            <div>
                ...
                <span class="fw-semibold"><?php echo $__env->yieldContent('page-title', 'Dashboard Admin'); ?></span>
            </div>
...
</html><?php /**PATH C:\buku-digital\resources\views/layouts/admin.blade.php ENDPATH**/ ?>