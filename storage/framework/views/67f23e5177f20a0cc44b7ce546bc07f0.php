...
unset($__errorArgs, $__bag); ?>" required>
                                <option value="reader" <?php echo e(old('role') == 'reader' ? 'selected' : ''); ?>>Pembaca (Reader)</option>
                                <option value="author" <?php echo e(old('role') == 'author' ? 'selected' : ''); ?>>Penulis (Author)</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="text-center">
                        <p class="mb-0 text-muted">Sudah punya akun? <a href="<?php echo e(route('login')); ?>" class="text-decoration-none">Masuk di sini</a></p>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\buku-digital\resources\views/auth/register.blade.php ENDPATH**/ ?>